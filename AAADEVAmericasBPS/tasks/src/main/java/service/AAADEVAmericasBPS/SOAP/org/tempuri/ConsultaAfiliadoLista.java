 ...
 *         &lt;element name="idCampanaTitan" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ConsultaAfiliadoLista")
public class ConsultaAfiliadoLista {

    protected int tipoDocumento;
    protected String numeroDocumento;
    protected String idLlamada;
    protected int idCampanaTitan;
    ...
    /**
     * Gets the value of the idCampanaTitan property.
     * 
     */
    public int getIdCampanaTitan() {
        return idCampanaTitan;
    }

    /**
     * Sets the value of the idCampanaTitan property.
     * 
     */
    public void setIdCampanaTitan(int value) {
        this.idCampanaTitan = value;
    }
